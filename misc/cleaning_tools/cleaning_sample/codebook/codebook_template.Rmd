...
# meta_data$suppress_valtab[which(meta_data$var_name == "lcost_pos")] = T
# meta_data$suppress_valtab[which(meta_data$var_name == "q4_24a")] = T
...
# dataset = rbind(dataset,rep(NA,38))
# dataset = rbind(dataset,rep(NA,38))
# dataset = rbind(dataset,rep(NA,38))
# dataset = rbind(dataset,rep(NA,38))

variable_names = meta_data$var_name[1:20]
# variable_names = "q002a"
