...
gen_cleaning_skeleton = function(dataset){
  ...
  towrite = c(
    ...
    dataset <- readxl::read_excel('clean_main_data/downloads/SADP2022_V3_-_all_versions_-_False_-_2022-09-14-08-42-49.xlsx') |> 
    janitor::clean_names()
